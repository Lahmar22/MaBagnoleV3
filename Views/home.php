        ...
        <div class="container mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
                ...
                <div class="hidden md:flex space-x-8 items-center text-sm font-medium text-gray-300">
                    <a href="#vehicules" class="hover:text-blue-400 transition">Nos Véhicules</a>
    ...
    <section id="vehicules" class="py-20 bg-gray-900">
        <div class="container mx-auto px-6">
            <div class="flex flex-col md:flex-row justify-between items-end mb-12">
                ...
                <a href="#" class="text-blue-400 hover:text-blue-300 font-medium mt-4 md:mt-0 flex items-center gap-2 group">
